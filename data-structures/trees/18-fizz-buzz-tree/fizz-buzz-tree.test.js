...
const { BinaryTree, BinarySearchTree } = require('../17-breadth-first/breadth-first.js');
...
describe('Testing Binary Tree Challenges', () => {
    ...
    describe('Testing Challenge 16: Find Maxiumum: ', () => {
        ...
        it('Should find the maximum value #2', () => {
            let bst = new BinarySearchTree();
            bst.add(22)
            bst.add(55)
            bst.add(14)
    ...
    describe('Testing Challenge 17: Breadth First: ', () => {

        it('Should return the correct order of a breadth first traversal #1', () => {
            ...
            let expected = [2, 7, 5, 2, 6, 9];

            expect(actual).toEqual(expected);
        });


        it('Should return the correct order of a breadth first traversal #2', () => {
            let tree = new BinaryTree();
            tree.add(3);
            tree.add(15);
            tree.add(7);
            ...
            tree.add(15);
            let actual = tree.breadthFirst()
            let expected = [3, 15, 7, 5, 3, 5, 15];

            expect(actual).toEqual(expected);
        });
    });

    describe('Testing Challenge 18: Fizz Buzz Tree: ', () => {

        it('Should modify a tree in place according to the fizzbuzz rules #1', () => {
            let tree = new BinaryTree();
            tree.add(1);
            tree.add(5);
            tree.add(15);
            ...
            let expected = [1, 5, 7, 9, 15];
            expect(actual).toEqual(expected);

            fizzBuzzTree(tree);
            actual = tree.preOrder();
            expected = ['1', 'Buzz', '7', 'Fizz', 'FizzBuzz'];
            expect(actual).toEqual(expected);

        });

        it('Should modify a tree in place acoording to the fizzbuzz rules #2', () => {
            let tree = new BinaryTree()
            tree.add(3)
            tree.add(15)
            tree.add(7)
            ...
            let actual = tree.preOrder();
            let expected = [3, 15, 5, 3, 7, 5, 15];
            expect(actual).toEqual(expected);

            fizzBuzzTree(tree);
            actual = tree.preOrder();
            expected = ['Fizz', 'FizzBuzz', 'Buzz', 'Fizz', '7', 'Buzz', 'FizzBuzz'];
            expect(actual).toEqual(expected);
