...
const getEdges = require('../37-getEdges/get-edges.js');
...
describe('Testing Challenge 38: depthFirst: ', () => {

    it('Should handle example #1', () => {

        let my_graph = new Graph()
        let a = my_graph.addNode("A")
        let b = my_graph.addNode("B")
        let c = my_graph.addNode("C")
        let d = my_graph.addNode("D")
        let e = my_graph.addNode("E")
        let f = my_graph.addNode("F")
        let g = my_graph.addNode("G")
        let h = my_graph.addNode("H")
        ...
        my_graph.addEdge(c, g)

        my_graph.addEdge(d, e)
        my_graph.addEdge(d, h)
        my_graph.addEdge(d, f)
        my_graph.addEdge(d, b)

        let actual = depthFirst(my_graph, a)
        let expected = ['A', 'B', 'C', 'G', 'D', 'E', 'H', 'F']
    ...
    it('Should handle example #2', () => {
        ...
        let actual = depthFirst(my_graph, b)
        let expected = ['B', 'C', 'G', 'D', 'E', 'H', 'F']
